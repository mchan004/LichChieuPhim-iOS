...
class DetailComingSoonViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    self.navigationController?.setNavigationBarHidden(false, animated: true)
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(alertComment(_:)), name: Notification.Name.init(rawValue: "alertCommentComingSoon"), object: nil)
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if indexPath.row == 0 {
            ...
            let cell = tableView.dequeueReusableCell(withIdentifier: "row4", for: indexPath) as! Row4ComingSoonTableViewCell
